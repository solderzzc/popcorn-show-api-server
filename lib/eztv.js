...
eztv_map['dark-matter'] = 'faulty202';
...
exports.getAllShows =   function(cb) {
    if(cb == null) return;
        ...
        var title, show;
        var allShows = [];
	allShows.push({show: 'the whispers', id: false, slug: 'the-whispers'});
...
if (seedn> '10' && !link && (xvid1 || xvid2 || x264lol || x264k || x2642hd || x264o || x264IMMERSE || x264mSD || x264DIMENSION ||  x264xRed || rartv || ettv || publichd || eztv || SNEAkY || rarbg || abjex)) {
